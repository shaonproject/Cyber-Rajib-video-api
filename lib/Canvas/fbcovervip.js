...
exports.index = async (req, ress, next) => {
  module.exports.circle = async (image) => {
    ...
    let avt = (await axios.get(encodeURI(`https://graph.facebook.com/${uid}/picture?height=1500&width=1500&access_token=1073911769817594|aa417da57f9e260d1ac1ec4530b417de`), {
